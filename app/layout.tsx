...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Nivren — Code that reads like intent", description: "A safe, intent-first Edition 4 application language.", type: "website", images: [{ url: image, width: 2400, height: 1260, alt: "Nivren — Code that reads like intent." }] },
