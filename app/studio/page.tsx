...
export default function StudioPage() {
  return <>
    ...
    <section className="studio-hero shell">
      <div><span className="kicker">Nivren Studio 1.0 beta</span><h1>See what your program <em>means.</em></h1><p>A fast native editor that turns Nivren&apos;s intent, authority, failures, tasks, and performance into things you can inspect—not compiler folklore.</p><div className="hero-actions"><Link className="button primary" href="/studio/downloads">Download the public beta</Link><Link className="button secondary" href="/studio/docs">Explore the workflow</Link></div></div>
