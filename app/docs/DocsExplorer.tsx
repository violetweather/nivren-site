...
const sections: Section[] = [
  {
    ...
    paragraphs: ["The guided installer detects the operating system and CPU, verifies the selected archive, and asks before changing PATH or installing VS Code support. Every managed install has an ownership marker and machine-readable receipt.", "The current public download is the working Edition 5 beta.9 prerelease. Edition 5 is a breaking update: Edition 2, 3, and 4 sources are no longer supported, and retired spellings stop with diagnostics that name the Edition 5 form. Product Proof is still 3/4, so this is not a stable or 1.0 claim. Local rollback and signed stable, beta, and nightly manifest support are implemented; the public production channel key and manifests, clean-platform recovery matrix, and incident drill remain release gates."],
