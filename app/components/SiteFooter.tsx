    ...
    <footer className="site-footer">
      <div className="shell footer-grid">
        <div className="footer-brand">
          ...
          <span className="beta-note">0.10.0-beta.5 · Edition 2</span>
        </div>
        ...
        <div><h3>Edition 2</h3><a href="https://github.com/violetweather/nivren/tree/main/spec">Specifications</a><a href="https://github.com/violetweather/nivren/tree/main/conformance">Conformance</a><a href="https://github.com/violetweather/nivren/blob/main/SECURITY.md">Security</a></div>
      </div>
