...
export default function InstallPage() {
  return <>
    ...
    <div className="shell content-shell install-content">
      <div className="notice"><span className="notice-mark">!</span><div><strong>Compatibility beta</strong>Nivren 0.10 Edition 2 is ready for evaluation and pilot projects, but is not yet approved for running untrusted source, bytecode, or packages.</div></div>
      <InstallChooser />
